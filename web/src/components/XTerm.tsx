...
export default function (props: Props) {
  ...
  const handleSocketOpen = useMemoizedCallback(
  ...
  const handleSocketClose = useMemoizedCallback(
    (socket: WebSocket, e: Event) => {
  ...
  const handleSocketError = useMemoizedCallback(
    (socket: WebSocket, e: Event) => {
      setWebsocketState(-1);
  ...
  const createTerminal = useCallback(async () => {
    ...
    websocket.current.onopen = function (this, e) {
      handleSocketOpen(this, e);
    };
    websocket.current.onclose = function (this, e) {
      handleSocketClose(this, e);
    };
    websocket.current.onerror = function (this, e) {
      handleSocketError(this, e);
    };
    ...
    <div className={classes.root}>
      <img
        ...
        className={classnames(
          classes.mesosLogo,
          isReady ? classes.mesosLogoBackground : ""
        )}
      />
